...
# 🔴 2026-08-31 合併 PR #33 時一併讓號(原 `0010_project_comments`),
#    接在讓號後的 `0010_release_review` 之後。
revision = "0011_project_comments"
down_revision = "0010_release_review"
branch_labels = None
depends_on = None
